$(function () {
    ...
    $('.order-form').on('submit', function (e) {
        ...
        // 결제 정보가 만들어졌으면 iamport 로 실제 결제 시도
        if (merchant_id !== '') {
            IMP.request_pay({
...
// iamport 에 결제 정보가 있는지 확인 후에 결제 완료 페이지로 이동
